...
QT_MOC_LITERAL(3, 16, 24),
QT_MOC_LITERAL(4, 41, 27)
    },
    "Task\0completed\0\0requestedModalitiesReady\0"
...
void Task::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->requestedModalitiesReady((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Task::completed)) {
                *result = 0;
            }
        }
        {
            typedef void (Task::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Task::requestedModalitiesReady)) {
                *result = 1;
            }
        }
    }
...
// SIGNAL 1
void Task::requestedModalitiesReady(QString _t1)
{
